package com.bridgelabz.CollectionLibryAddressBook;
...
public class AddressBook {
	...
	/**
	 * Method to add contact next() method finds and returns the next complete token
	 * from this scanner
	 */
	public void add() {
		...
		boolean isPresent = list.stream().anyMatch(n -> n.getFirstName().equalsIgnoreCase(firstName)); // Java Streams
																										// is used to
																										// check if any
																										// duplicate
		if (isPresent) {
	...
	/**
	 * Methods for searching contacts based on state and get number of contact
	 * person
	 */
	...
	/**
	 * The String class represents character strings Overrides: toString in class
	 * Object
	 */
	@Override
